package koldunec.ammpdbm_mod.GUIs;
...
public class store_gui extends GuiContainer {
    ...
    private static final ResourceLocation CHEST_GUI_TEXTURE = new ResourceLocation(ammpdbm_mod.MODID,"textures/gui/generic_54.png");
