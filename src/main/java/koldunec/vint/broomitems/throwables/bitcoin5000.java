package koldunec.vint.broomitems.throwables;
...
public class bitcoin5000 extends base_item {

    public bitcoin5000(String name, int stackMax){
        super(name,stackMax);
    }
    ...
    public ActionResult<ItemStack> onItemRightClick(World world, EntityPlayer player, EnumHand hand) {
        ...
        if (!world.isRemote) {
            entityBitcoin b = new entityBitcoin(world, player);
